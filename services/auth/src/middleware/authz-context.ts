...
export const registerAuthzContext = (app: FastifyInstance): void => {
  app.addHook('onRequest', async (request: FastifyRequest) => {
    ...
    // logging estructurado (sin tabla nueva por servicio) -- el registro
    // "fuerte" del acceso ya vive en SupportAccessGrant, esto es solo para
    // poder correlacionar qué hizo el actor mientras estuvo elevado.
