...
export const registerDoctorRoutes = (app: FastifyInstance, deps: DoctorRoutesDeps = {}): void => {
  ...
  app.post('/v1/doctors', { schema: { body: CreateDoctorBody } }, controller.create);
  app.get('/v1/doctors', controller.listAll);
  app.get('/v1/doctors/:id', { schema: { params: DoctorIdParams } }, controller.getById);
