...
// Mismo molde que services/auth/src/middleware/authz-context.ts. A
// diferencia de tenant-context.ts (que en las rutas públicas por posesión
// de UUID resuelve el tenant DENTRO del servicio, ver runWithTenant), este
// middleware no tiene un caso análogo: si no hay USER_ROLE_HEADER
// simplemente no hay actor (paciente sin cuenta), y las rutas públicas
// usan requirePermission(..., { allowAnonymous: true }) para dejarlo pasar.
