...
-- explícito (GRANT es aditivo: la ALTER DEFAULT PRIVILEGES de
-- 20260730200000_add_tenant_id_rls ya le da UPDATE/DELETE a app_role sobre
-- toda tabla nueva -- ver el mismo fix aplicado en Auth/Appointments/Doctors).
